...
export const ERROR_MESSAGES = {
  [ERROR_CODES.EAlreadyClaimed]:
    "You have already claimed tokens today. Please wait until tomorrow.",
  [ERROR_CODES.EInvalidCoupon]:
    "Invalid coupon code. Please check and try again.",
  [ERROR_CODES.ECouponAlreadyUsed]: "You have already used this coupon code.",
  [ERROR_CODES.ENotAdmin]:
    "You don't have admin permissions to perform this action.",
  [ERROR_CODES.ENoBadge]: "You don't own this badge.",
  [ERROR_CODES.EAlreadyRedeemed]: "You have already redeemed a badge.",
  [ERROR_CODES.EInsufficientBalance]:
  ...
  try {
    if (error?.message?.includes("MoveAbort")) {
      ...
      if (
        ...
        message.includes("ealreadyredeemed")
      ) {
        parsedError = createWKTError(ERROR_CODES.EAlreadyRedeemed);
      } else if (
        message.includes("insufficient balance") ||
        message.includes("einsufficientbalance")
      ) {

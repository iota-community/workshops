...
export default function ActionTabs({
  ...
  const getTabStyle = (tab: "tab1" | "tab2") => ({
    ...
    borderBottom: selectedTab === tab ? `2px solid ${colors.primaryLight}` : "2px solid transparent",
      ...
      <Tabs.Content value="tab1" style={{ position: "relative" }}>
        <Card style={cardStyle}>
          <Flex direction="column" gap="4">
            ...
            <Text size="3" style={{ lineHeight: 1.5, color: colors.textSecondary }}>
              Claim your daily tokens, redeem bonus tokens using coupons, or send tokens to others within the network.
            </Text>
                ...
                <Link to="/claim-tokens" style={{ textDecoration: "none" }}>
                  <Button
                    ...
                    style={{
                      ...
                      padding: "14px 20px", 
                      fontSize: 16,
                      background: hasClaimed ? colors.textSecondary : "linear-gradient(135deg, #805ad5 0%, #9f7aea 100%)",
                ...
                <Link to="/make-payment" style={{ textDecoration: "none" }}>
                  <Button
                    ...
                    style={{
                      ...
                      padding: "14px 20px", 
                      fontSize: 16,
                      background: totalBalance === BigInt(0) ? colors.textSecondary : "linear-gradient(135deg, #805ad5 0%, #9f7aea 100%)",
      ...
      <Tabs.Content value="tab2">
        <Card style={cardStyle}>
          <Flex direction="column" gap="4">
            ...
            <Text size="3" style={{ lineHeight: 1.5, color: colors.textSecondary }}>
              Redeem your earned badges for bonus tokens or explore your badge gallery to track your workshop achievements.
            </Text>
                ...
                <Link to="/redeem-badge" style={{ textDecoration: "none" }}>
                  <Button
                    ...
                    style={{
                      ...
                      padding: "14px 20px", 
                      fontSize: 16,
                      background: (badges.length === 0 || hasRedeemed) ? colors.textSecondary : "linear-gradient(135deg, #805ad5 0%, #9f7aea 100%)",

...
export default function BadgeGallery() {
  ...
  return (
    <Flex direction="column" align="center" gap="6" style={{ padding: 20, minHeight: "100vh" }}>
      ...
      {badges.length === 0 ? (
        ...
        >
          <Text size="5" weight="medium" style={{ marginBottom: 16,display: "block" }}>
            You don't have any workshop badges yet.
          </Text>
          <Text size="4" style={{ lineHeight: 1.5,display: "block" }}>
            Earn badges by participating in workshops and redeem them for tokens.
          </Text>
        </Card>
      ) : (
        <Flex
  ...
  overflow: 'hidden', 
              ...
              onMouseEnter={(e) => {
    const button = e.currentTarget.querySelector('.redeem-button-container');
...
onMouseLeave={(e) => {
    ...
    if (button) (button as HTMLElement).style.opacity = '0';
            ...
            >
              ...
              />
              <Text size="5" weight="bold" align="center" style={{ color: "#cfd8dcff" }}>
              ...
              <Text
                size="3"
                align="center"
                style={{ wordBreak: "break-all", color: "#6b7280", fontFamily: "monospace" }}
              >
  ...
  style={{
    ...
    right: 0,
    padding: '20px',
    background: 'linear-gradient(to top, rgba(26, 26, 26, 0.9) 30%, transparent)',
    display: 'flex',

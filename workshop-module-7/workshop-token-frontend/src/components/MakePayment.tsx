...
export default function MakePayment() {
  const { account, makePayment, getWKTBalance, getWorkshopBadges } =
    useWKTContract();
      ...
      >
        ...
        >
          <Text
            size="6"
            weight="bold"
            style={{ marginBottom: 16, color: "#51cf66", display: "block" }}
          >
            Make Payment
          </Text>
          <Text
          ...
          >
            Transfer your WKT tokens to another wallet address. Make sure you
          ...
          >
            <div>
              <Button
                ...
                disabled={
                  loading || !account || !recipient || !amount || !coinId
                }
                style={{
                  width: "100%",
                  fontWeight: 600,
